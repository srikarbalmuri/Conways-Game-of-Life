...
echo "<h3>Please fill all the required fields</h3>";
}
else
{
...
if($rnum==0) { //if true, insert new data
          ...
          if($stmt->execute()) {
        echo '<h3>Register successfully, Please login with your credentials</h3>';}
        } else { 
       echo '<h3>Someone already register with this email address</h3>';
     }
$stmt->close();
